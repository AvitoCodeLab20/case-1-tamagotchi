...
Go-сервис Avito Tamagotchi. Он поднимает HTTP-сервер, подключается к PostgreSQL и реализует аутентификацию, недельный лидерборд и пользовательские награды.
